...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    double abovePadding = MediaQuery.of(context).padding.top + MediaQuery.of(context).padding.bottom + 30;
    print(abovePadding);
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Row(
                      children: <Widget>[
                        input(labelText: "Email Address", hintText: "sagar@sewaa.com"),
                      ],
                    ),
                    Row(
                      children: <Widget>[
                        ...
                        child: RaisedButton(
                          ...
                          child: RichText(
                            text: TextSpan(children: <TextSpan>[
                              TextSpan(text: "Login", style: TextStyle(letterSpacing: 1, color: white, fontSize: 16, fontWeight: FontWeight.bold)),
                            ]),
                          ),
                        ),
                      ),
