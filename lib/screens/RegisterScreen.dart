              ...
              AnimatedContainer(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Row(
                      children: <Widget>[
                        input(labelText: "Confirm Password", hintText: "********"),
                      ],
                    ),
                    Center(
                      child: SizedBox(
                        ...
                        child: RaisedButton(
                          ...
                          child: RichText(
                            text: TextSpan(children: <TextSpan>[
                              TextSpan(text: "Register", style: TextStyle(color: white, fontSize: 16, fontWeight: FontWeight.bold)),
                            ]),
                          ),
                        ),
                      ),
                      ...
                      children: <Widget>[
                        ...
                        FlatButton(
                          ...
                          child: Text(
                            "Terms and Condition",
                            overflow: TextOverflow.ellipsis,
                            style: TextStyle(fontSize: 12, fontStyle: FontStyle.italic, color: primaryColor, fontWeight: FontWeight.bold),
                          ),
                        ),
                      ],
                    ),
